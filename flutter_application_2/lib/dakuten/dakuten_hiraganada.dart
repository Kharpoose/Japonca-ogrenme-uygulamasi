...
class DakutenHiraganada extends StatelessWidget {
  const DakutenHiraganada({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hiraganada Dakuten',
            style: TextStyle(
              fontSize: 25,
            )),
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const Text(
              'Hiraganada Dakutenin uygulanması',
            ...
            Container(margin: const EdgeInsets.all(8.0)),
            const Text(
              'Hiraganadaki Dakuten ve Handakuten uygulamalarını kısaca anlatmak gerekirse:',
